  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={`flex flex-col items-center justify-center w-full relative transition-all duration-500 ease-in-out ${isDynamicHeaderPage && isScrolled ? 'max-h-0 opacity-0 pointer-events-none mb-0 overflow-hidden' : 'max-h-[240px] opacity-100 mb-0.5 overflow-visible'
          }`}>
          {/* TikTok - Above Logo */}
          <div className="mb-1">
