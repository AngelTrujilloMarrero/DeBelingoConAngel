...
const Navigation: React.FC = () => {
  ...
  return (
    <nav className="bg-black/10 backdrop-blur-[2px] p-1.5 md:p-2 rounded-full max-w-full overflow-x-auto no-scrollbar">
      <div className="px-1 sm:px-4">
        <div className="flex justify-center items-center flex-nowrap gap-1 sm:gap-2">
